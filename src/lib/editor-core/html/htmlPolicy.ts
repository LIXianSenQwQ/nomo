...
export const EDITABLE_INLINE_TAGS: ReadonlySet<string> = new Set(['span', 'strong', 'em', 'a', 'code']);
...
export const DANGEROUS_TAGS: ReadonlySet<string> = new Set([
  'script', 'style', 'iframe', 'form', 'input', 'button', 'svg',
  'object', 'embed', 'base', 'link', 'meta', 'noscript', 'frame', 'frameset'
]);
